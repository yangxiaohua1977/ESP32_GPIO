...
void led1_flash(uint8_t dir);
void led2_flash(uint8_t dir);
...
void led1_flash(uint8_t dir)
{
    uint16_t index, indey, datmp, bitcnt;
    uint32_t timecnt;
    //for(;;) {
    		/*
    		* elevator up
